      ...
      <Layout>
        ...
        <div className="mt-10 mx-auto max-w-xs text-center">
          <div className="my-5 flex items-center hover:text-yellow-400">
            <svg
              className="fill-current dark:text-white block h-6 w-6"
              role="img"
              viewBox="0 0 24 24"
            ...
            <a className="ml-4" href="https://linkedin.com/in/zulnabil" target="_blank">
          ...
          <div className="my-5 flex items-center hover:text-yellow-400">
            ...
            <a className="ml-4" href="https://github.com/zulnabil" target="_blank">
              github.com/zulnabil
            </a>
          </div>
          <div className="my-5 flex items-center hover:text-yellow-400">
            ...
            <a className="ml-4" href="https://t.me/zulnabil" target="_blank">
              t.me/zulnabil
            </a>
          </div>
          <div className="my-5 flex items-center hover:text-yellow-400">
            ...
            <a className="ml-4" href="mailto:zulnabil.22@gmail.com" target="_blank">
